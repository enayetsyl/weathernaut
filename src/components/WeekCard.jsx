...
import {WbSunnyOutlinedIcon, FilterDramaOutlinedIcon,UmbrellaOutlinedIcon, ThunderstormOutlinedIcon,SevereColdOutlinedIcon,WaterOutlinedIcon, ClearIcon, CardContent, Typography } from "../constant/index";
    ...
    '>
      <CardContent>
       <div className='flex justify-between items-center gap-5'>
        ...
        Temperature{" "}{item.main.temp}{" "}<span>{unit === 'celsius' ? 'C' : 'F'}</span>
        </Typography>
        <Typography variant="body2">
        Feels Like{" "}{item.main.feels_like}{" "}<span>{unit === 'celsius' ? 'C' : 'F'}</span>
        </Typography>
        <Typography variant="body2">
        Maximum Temp{" "}{item.main.temp_max}{" "}<span>{unit === 'celsius' ? 'C' : 'F'}</span>
        </Typography>
        <Typography variant="body2">
        Minimum Temp{" "}{item.main.temp_min}{" "}<span>{unit === 'celsius' ? 'C' : 'F'}</span>
        </Typography>
        <Typography variant="body2">
